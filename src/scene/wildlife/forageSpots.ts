 ...
 *
 * Гнездо ровно одно на весь лес: яйцо — самая редкая находка, и второе гнездо
 * удваивало бы её добычу. Грибов трое: их спрос вдвое выше (два на порцию), и
 * отрастают они куда неохотнее (см. MUSHROOM_REGROW в game/store.ts).
 *
 * Порядок перемешан намеренно: деревья отсортированы по расстоянию от фермы, и
 * при сплошных блоках все грибы оказались бы у ближней опушки, а гнездо — у

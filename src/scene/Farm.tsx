...
import { clearAllHoverLabels } from './hoverLabel'
import { hoverProp, materialName, unhoverProp } from './propHover'
 ...
 */
const RAYCAST_PROP = { raycast: THREE.InstancedMesh.prototype.raycast } as unknown as Record<
  string,
  never
>
